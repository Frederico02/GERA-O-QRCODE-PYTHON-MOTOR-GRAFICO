...
# Cria um botão para limpar entrada
botao_limpar = tk.Button(frame, text="Limpar", command=limpar_entrada, activebackground='green')
botao_limpar.pack(side=tk.RIGHT, padx=5, pady=5)

# Cria um botão que executa a função imprimir_etiqueta()
botao_imprimir = tk.Button(frame, text="Gerar", command=imprimir_etiqueta, activebackground='blue')
botao_imprimir.pack(side=tk.RIGHT, padx=6, pady=6)
